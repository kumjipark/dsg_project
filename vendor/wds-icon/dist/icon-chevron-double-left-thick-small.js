...
//#region src/icon-chevron-double-left-thick-small.tsx
/**
* 왼쪽으로 큰 상태 변화를 표현합니다.
* 키워드: Thick, 왼쪽 꺾쇠, 굵은, 얇은, 작은, 큰, Double Chevron, Left, Small
* 속성: Outlined
*/
const IconChevronDoubleLeftThickSmall = (0, react.forwardRef)((props, ref) => {
...
//#endregion
exports.default = IconChevronDoubleLeftThickSmall;
