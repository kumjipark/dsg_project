...
//#region src/icon-chevron-double-right-small.tsx
/**
* 오른쪽으로 큰 상태 변화를 표현합니다.
* 키워드: 오른쪽 꺾쇠, 굵은, 얇은, 작은, 큰, Double Chevron, Right, Small, Big
* 속성: Outlined
*/
const IconChevronDoubleRightSmall = (0, react.forwardRef)((props, ref) => {
...
//#endregion
exports.default = IconChevronDoubleRightSmall;
