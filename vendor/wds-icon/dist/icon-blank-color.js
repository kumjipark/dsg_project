...
//#region src/icon-blank-color.tsx
/**
* 기본 표시를 위한 아이콘으로, 쓰지 않습니다.
*/
const IconBlankColor = (0, react.forwardRef)((props, ref) => {
	const id1 = (0, react.useId)();
	const id2 = (0, react.useId)();
	const id3 = (0, react.useId)();
	const id4 = (0, react.useId)();
	const id5 = (0, react.useId)();
	const id6 = (0, react.useId)();
	const id7 = (0, react.useId)();
	const id8 = (0, react.useId)();
	const id9 = (0, react.useId)();
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("defs", { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("linearGradient", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("stop", { stopColor: "white" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("stop", {
						offset: "1",
						stopColor: "#F7F7F8"
					})]
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("linearGradient", {
					...
					y2: "21.6501",
					gradientUnits: "userSpaceOnUse",
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("stop", { stopColor: "#5B84FF" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("stop", {
						offset: "1",
						stopColor: "#3366FF"
					})]
				}),
...
//#endregion
exports.default = IconBlankColor;
