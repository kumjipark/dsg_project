...
//#region src/icon-compass-fill.tsx
/**
* 나침반을 표현합니다.
* 키워드: 콤파스, 컴파스, 나침반, 방향, Direction, Compass, Way, Path
* 속성: Solid
*/
const IconCompassFill = (0, react.forwardRef)((props, ref) => {
