...
const buttonStyle = ({ loading, xs, sm, md, lg, xl, ...props }) => (theme) => css`
    display: inline-flex;
    align-items: center;
...
const buttonColorStyle = ({ variant, color } = {}, theme) => {
	switch (true) {
		case variant === "solid" && color === "primary": return css`
      ...
      `;
		case variant === "solid" && color === "assistive": return css`
      ...
      `;
		case variant === "outlined" && color === "primary": return css`
      ...
      `;
		case variant === "outlined" && color === "assistive": return css`
