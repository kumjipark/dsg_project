...
const segmentedControlStyle = ({ variant, size, xs, sm, md, lg, xl }) => (theme) => css`
    position: relative;
    width: 100%;
...
const motionThumbStyle = (theme) => css`
  position: absolute;
  ...
  &::before {
    ...
    background-color: ${addOpacity(theme.semantic.static.white, theme.opacity[28])};
  }
`;
const segmentedControlItemStyle = ({ size, disabled, variant, xs, sm, md, lg, xl }) => (theme) => css`
    position: relative;
    padding: 0px 16px;
    height: 100%;
    cursor: pointer;
