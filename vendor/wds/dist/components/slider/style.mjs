...
const sliderProgressWrapperStyle = ({ disabled }) => (theme) => css`
    padding: 8px;
...
`;
const sliderProgressRangeStyle = css`
  position: absolute;
  border-radius: inherit;
  height: 100%;
`;
const sliderThumbStyle = (theme) => css`
  width: 20px;
  height: 20px;
...
`;
const sliderThumbInteractionStyle = (theme) => css`
  background-color: ${theme.semantic.primary.normal};
  opacity: 0;
  width: calc(100% + 12px);
