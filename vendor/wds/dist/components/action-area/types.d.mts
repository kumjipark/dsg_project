...
//#region src/components/action-area/types.d.ts
type ActionAreaProps = WithSxProps<{
  children?: ReactNode;
  /**
   ...
   */
  extra?: boolean; /** Displays a caption above the buttons. */
  caption?: ReactNode;
  /**
...
type ActionAreaButtonProps = WithSxProps<{
  children?: ReactNode;
...
//#endregion
export { ActionAreaButtonProps, ActionAreaProps };