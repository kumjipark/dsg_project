import { ThumbnailProps } from "./types.mjs";
...
//#region src/components/thumbnail/style.d.ts
declare const thumbnailStyle: ({
  ratio,
  portrait,
  radius,
  border,
  ...
  lg,
  xl
}: ThumbnailProps) => (theme: Theme) => SerializedStyles$1;
//#endregion
