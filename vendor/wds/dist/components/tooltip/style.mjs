...
`;
const tooltipWrapperStyle = ({ size, xs, sm, md, lg, xl }) => (theme) => css`
...
const tooltipContentStyle = (theme) => css`
  border-radius: inherit;
  background-color: ${addOpacity(theme.semantic.inverse.background, theme.opacity[88])};
  ...
  button {
    color: ${addOpacity(theme.semantic.inverse.label, theme.opacity[61])} !important;
  }
...
`;
const tooltipContentShortcutStyle = (theme) => css`
