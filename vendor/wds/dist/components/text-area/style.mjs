...
const textAreaWrapperStyle = ({ disabled, invalid, width = "fit-content", xs, sm, md, lg, xl }) => (theme) => css`
    border: none;
	...
	xl
      ...
      `)}
  `;
const textAreaStyle = ({ xs, sm, md, lg, xl }) => (theme) => css`
	...
	xl
      ...
      `)}
  `;
const textAreaBottomAreaStyle = css`
  width: 100%;
`;
const textAreaContentStyle = css`
  flex-shrink: 0;
  width: fit-content;
  height: fit-content;
`;
const textAreaCharacterCounterStyle = (theme) => css`
  padding: 0px 4px;
