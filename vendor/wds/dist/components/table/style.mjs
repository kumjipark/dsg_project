'use client';
import { activeInteractionStyle, hoverInteractionStyle } from "../with-interaction/style.mjs";
import { css } from "@wanteddev/wds-engine";
//#region src/components/table/style.ts
const tableStyle = (theme) => css`
...
const tableCellStyle = css`
  ...
  border-bottom: 1px solid var(--wds-table-border-color);
`;
const tableRowStyle = (interaction) => (theme) => css`
  position: relative;
  display: table-row;
  margin: 0;
  padding: 0;
  ...
  `}
`;
const tableHeadStyle = (isSticky) => (theme) => css`
  margin: 0;
  padding: 0;
