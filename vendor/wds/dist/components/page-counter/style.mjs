...
const pageCounterStyle = ({ alternative, size, xs, sm, md, lg, xl }) => (theme) => css`
    list-style: none;
    margin: 0px;
    ...
    &::before {
      ...
      ${alternative ? css`
          ...
          ` : css`
            ...
            background-color: ${addOpacity(theme.semantic.static.white, theme.opacity[35])};
    ...
    ${alternative ? css`
          ...
          [data-role='page-counter-divider'] {
            color: ${addOpacity(theme.semantic.static.white, theme.opacity[52])};
          }
        ` : css`
          [data-role='page-counter-text'] {
            color: ${addOpacity(theme.semantic.static.white, theme.opacity[88])};
...
const backgroundBlendStyle = (theme) => css`
  position: absolute;
  content: '';
  background-color: ${addOpacity(theme.semantic.static.black, theme.opacity[28])};
  width: 100%;
  height: 100%;
  top: 0px;
  left: 0px;
