...
const playBadgeStyle = ({ size, alternative, xs, sm, md, lg, xl }) => (theme) => css`
    margin: 0px;
    ...
    ${alternative ? css`
        ...
        ` : css`
          ...
          background-color: ${addOpacity(theme.atomic.coolNeutral[40], theme.opacity[28])};
        `}
