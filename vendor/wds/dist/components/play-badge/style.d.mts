import { PlayBadgeProps } from "./types.mjs";
...
//#region src/components/play-badge/style.d.ts
declare const playBadgeStyle: ({
  size,
  alternative,
  xs,
  sm,
  ...
  lg,
  xl
}: PlayBadgeProps) => (theme: Theme) => SerializedStyles$1;
//#endregion
