...
//#region src/components/loading/style.ts
const loadingStyle = ({ size, xl, lg, md, sm, xs }) => (theme) => _wanteddev_wds_engine.css`
    width: ${size};
    height: ${size};
    margin: 0 auto;
	...
	xs
        ...
        ${params?.size !== void 0 && _wanteddev_wds_engine.css`
          width: ${params.size};
          height: ${params.size};
        `}
        ${params?.sx}
      `)}
  `;
const loadingCircularAnimatedSvgStyle = (theme) => _wanteddev_wds_engine.css`
  @keyframes array {
    0%,
    25%,
    50%,
...
`;
const loadingWantedAnimatedSvgStyle = (theme) => _wanteddev_wds_engine.css`
  --time: 0.9;
...
`;
//#endregion
exports.loadingCircularAnimatedSvgStyle = loadingCircularAnimatedSvgStyle;
exports.loadingStyle = loadingStyle;
exports.loadingWantedAnimatedSvgStyle = loadingWantedAnimatedSvgStyle;
