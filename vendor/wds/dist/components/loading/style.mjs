...
const loadingStyle = ({ size, xl, lg, md, sm, xs }) => (theme) => css`
    width: ${size};
    height: ${size};
    margin: 0 auto;
	...
	xs
      ...
      `)}
  `;
const loadingCircularAnimatedSvgStyle = (theme) => css`
  @keyframes array {
    0%,
    25%,
    50%,
...
`;
const loadingWantedAnimatedSvgStyle = (theme) => css`
  --time: 0.9;
