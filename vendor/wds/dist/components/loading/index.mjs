...
import { LOADING_NAME } from "./constants.mjs";
import { loadingCircularAnimatedSvgStyle, loadingStyle, loadingWantedAnimatedSvgStyle } from "./style.mjs";
import { Box } from "@wanteddev/wds-engine";
import { forwardRef } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
//#region src/components/loading/index.tsx
const Loading = forwardRef(({ variant = "wanted", size = "32px", xl, lg, md, sm, xs, sx, ...props }, ref) => {
	const loadingSvgRender = () => {
		switch (variant) {
			case "wanted": return /* @__PURE__ */ jsx(LoadingWantedAnimatedSvg, {});
			case "circular": return /* @__PURE__ */ jsx(LoadingCircularAnimatedSvg, {});
		}
	};
