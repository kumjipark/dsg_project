...
const require_components_loading_constants = require("./constants.js");
const require_components_loading_style = require("./style.js");
let _wanteddev_wds_engine = require("@wanteddev/wds-engine");
let react = require("react");
let react_jsx_runtime = require("react/jsx-runtime");
//#region src/components/loading/index.tsx
const Loading = (0, react.forwardRef)(({ variant = "wanted", size = "32px", xl, lg, md, sm, xs, sx, ...props }, ref) => {
	const loadingSvgRender = () => {
		switch (variant) {
			case "wanted": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LoadingWantedAnimatedSvg, {});
			case "circular": return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LoadingCircularAnimatedSvg, {});
		}
	};
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_components_flex_box_index.FlexBox, {
		ref,
		...props,
		sx: [require_components_loading_style.loadingStyle({
			size,
			xl,
			lg,
			md,
		...
		children: loadingSvgRender()
	});
});
Loading.displayName = require_components_loading_constants.LOADING_NAME;
const LoadingWantedAnimatedSvg = () => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_wanteddev_wds_engine.Box, {
		as: "svg",
		viewBox: "0 0 24 24",
		xmlns: "http://www.w3.org/2000/svg",
		sx: require_components_loading_style.loadingWantedAnimatedSvgStyle,
...
const LoadingCircularAnimatedSvg = () => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_wanteddev_wds_engine.Box, {
		...
		viewBox: "0 0 28 28",
		xmlns: "http://www.w3.org/2000/svg",
		sx: require_components_loading_style.loadingCircularAnimatedSvgStyle,
