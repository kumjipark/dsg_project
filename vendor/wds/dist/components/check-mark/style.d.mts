import { CheckMarkProps } from "./types.mjs";
...
//#region src/components/check-mark/style.d.ts
declare const checkMarkStyle: ({
  size,
  bold,
  tight,
  xs,
  ...
  lg,
  xl
}: CheckMarkProps) => (theme: Theme) => SerializedStyles$1;
//#endregion
export { checkMarkStyle };