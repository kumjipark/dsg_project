...
const require_components_date_picker_style = require("./style.js");
const require_components_date_picker_hooks = require("./hooks.js");
...
const DatePicker = (0, react.forwardRef)(({ disabled, readOnly, value: originValue, defaultValue, onChange, defaultOpen, open: originOpen, onOpenChange, defaultView, view, views, onViewChange, contentProps, format = "YYYY.MM.DD", placeholder = format, min, max, locale = "ko-KR", timezone, onChangeComplete, inputRef: originInputRef, yearsOrder, input, actionArea, invalid: originInvalid, disableLastUnitClickClose, ...props }, forwardedRef) => {
	...
	const { inputRef, inputValue, focusedSection, handleBlur, handleClick, handleFocus, handleKeyDown, handlePaste, handleValueChange, handleInputValueChange } = require_components_date_picker_hooks.useDateField({
		value,
		format,
		locale,
		timezone,
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_components_focus_scope_index.FocusScope, {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_components_dismissable_layer_index.DismissableLayer, {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(require_components_flex_box_index.FlexBox, {
					...
					sx: [require_components_date_picker_style.datePopperStyle, contentSx],
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_components_date_calendar_index.DateCalendar, {
						min,
						max,
						timezone,
						locale,
...
const DatePickerField = (0, react.forwardRef)(({ inputRef, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_components_text_field_index.TextField, {
	...props,
	ref: inputRef,
	wrapperRef: ref
}));
