...
const topNavigationStyle = ({ background, variant, xs, sm, md, lg, xl }) => (theme) => css`
    width: 100%;
    align-items: center;
    position: relative;
...
const topNavigationFloatingBackgroundStyle = (theme) => css`
  pointer-events: none;
  position: absolute;
  top: 0px;
  left: 0px;
...
const topNavigationButtonTextStyle = css`
  padding: 0px;
  flex-shrink: 0;
